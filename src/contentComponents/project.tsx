...
// 						transition={{ duration: 0.6, delay: 0.4 }}
// 						className="md:h-full md:w-auto w-full h-auto border-2 rounded-lg border-black shadow-lg"
// 						alt="todo list project"
// 						baseName="web-todolist"					
// 					/>
// 					<motion.div className="max-w-lg">
...
// 						transition={{ duration: 0.6, delay: 0.4 }}
//                         className="text-sm md:text-base leading-relaxed text-gray-200 font-sriracha">
