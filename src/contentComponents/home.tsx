    ...
    return (
        <section {...props} className="h-full flex justify-center items-center flex-col text-start">
            ...
            <div className="flex flex-wrap gap-4">
                <button onClick={() => scrollToComponents(componentsRef.projectsRef)} className="mt-7 font-action border border-yellow-500 p-2 break-words whitespace-normal bg-gradient-to-r transform-gpu hover:-translate-y-2 hover:border-white active:border-white hover:shadow-2xl cursor-pointer active:-translate-y-2 from-yellow-300 via-white to-yellow-300  bg-clip-text text-transparent rounded-sm">Projects</button>
                {/* <button onClick={() => scrollToComponents(componentsRef.projectsRef)} className="mt-7 font-action border border-yellow-500 p-2 break-words whitespace-normal bg-gradient-to-r transform-gpu hover:-translate-y-2 hover:border-white active:border-white hover:shadow-2xl cursor-pointer active:-translate-y-2 from-yellow-300 via-white to-yellow-300  bg-clip-text text-transparent">Curriculum Vitae</button> */}
                <button className="mt-7 font-action border border-yellow-500 p-2 break-words whitespace-normal bg-gradient-to-r transform-gpu hover:-translate-y-2 hover:border-white active:border-white hover:shadow-2xl cursor-pointer active:-translate-y-2 from-yellow-300 via-white to-yellow-300  bg-clip-text text-transparent rounded-sm">
                    <a href="https://blog.manu-tech.my.id/manuTech0">Blog</a>
                </button>
            </div>
        </section>
    )
